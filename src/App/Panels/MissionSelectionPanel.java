...
public class MissionSelectionPanel extends JPanel {
    ...
    public MissionSelectionPanel(
        ...
        memberSelectionPanel.setPreferredSize(new Dimension((halfWidth - (SCROLL_BAR_WIDTH)), HEIGHT));
        ...
        this.add(missionDetailsPanel, BorderLayout.CENTER);
        ...
        selectedPanel.setPreferredSize(new Dimension(halfWidth, ((int) (HEIGHT * 0.3))));
        selectedPanel.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));

        listPanel.setPreferredSize(new Dimension(halfWidth, ((int) (HEIGHT * 0.7))));
        ...
        missionCenterPanel.setBackground(new Color(50, 43, 56));

        missionCenterPanel.setPreferredSize(new Dimension(availableWidth, (int) (HEIGHT * 0.92)));
        missionCenterPanel.setBackground(new Color(50, 43, 56));
        ...
        textWrapperPanel.setPreferredSize(new Dimension(-1, -1)); // TODO make this calculated dynamically
        ...
        missionRequiredSpellPanel.setBackground(new Color(50, 43, 56));
        ...
        buttonPanel.setPreferredSize(new Dimension(availableWidth, (int) (HEIGHT * 0.08)));
    ...
    private int sampleLinePadding(JTextArea textArea, Font font, int availableWidth){
        String text = textArea.getText();
        Dimension size = textArea.getSize();
        textArea.setFont(font);
        textArea.setSize(availableWidth, Integer.MAX_VALUE);
        textArea.setText("Hello");
        int oneLineHeight = textArea.getPreferredSize().height;
        textArea.setText("Hello\nWorld");
        int twoLineHeight = textArea.getPreferredSize().height;
